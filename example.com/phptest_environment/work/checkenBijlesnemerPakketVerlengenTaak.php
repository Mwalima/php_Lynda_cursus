...
class CheckenBijlesnemerPakketVerlengenTaak {
    ...
    //en pakket uren zijn meer dan 0 of als er een pakket stop =`1
        ...
        return "bijlesplanning regels verlengd : %d\n" . $query->getAffectedRows();
    }

    public function listOfBijlesnemerVerlengenPakket(){
        //verleng de pakketen
        ...
        $message = "</br>periode die verlengd word ".$periode_over_een_jaar->getYear().$periode_over_een_jaar->getMonth();
        $message .= "</br>maanden waarmee verlengd word ".$periode_over_een_jaar->addMonthsToString(12);
        $message .="</br> tot en met ".$periode_over_een_jaar->getYear()." maand: ".$periode_over_een_jaar->getMonth();
    
        return $message;
    }

    public function BijlesnemerPlanningVerlengd() {
