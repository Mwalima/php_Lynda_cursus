...
and pak2.`stop` = 0 AND x.bijlesnemer_id=25035
");
...
printf($query->getAffectedRows());

//verleng de pakketen
$bijlesnemer_id = 25035;
...
foreach ($sql as $row){
    echo "<br>";
    echo "<br>";
    echo "bijlesnemer_id".$row['bijlesnemer_id']."<br>";
...
if($row[0]['jaar'] == $row[1]['jaar']+1){
    echo "bijlesplanning is correct verlengd";
}
