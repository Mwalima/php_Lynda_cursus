...
$_SESSION['server'] = '192.168.7.246';
$_SESSION['dbuser'] = 'stplus';
$_SESSION['pass'] = 'stplus';
$_SESSION['dbname']= 'test';
...
function db_connect ($server, $dbuser, $pass, $dbname) {
    try {
        $conn = new PDO("mysql:host=$server;dbname=$dbname", $dbuser, $pass);
